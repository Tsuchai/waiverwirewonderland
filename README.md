...
Application to help you make quick and effective waiver-wire decisions in Fantasy Basketball!



A Flutter project for fantasy basketball waiver wire analysis.
...
Run the following command to download all the necessary packages listed in `pubspec.yaml` (including Riverpod).
```sh
flutter pub get
```
